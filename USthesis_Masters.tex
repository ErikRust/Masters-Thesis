...
\newglossaryentry{api}{name=API,description={Application Program Interface; As the name suggests is a link between various applications or programs described by a clearly defined API specification}}
...
\include{contents/Chap4_Results_Discussion}
